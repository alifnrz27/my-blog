<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button class="bg-red-500" wire:click="confirmLogout" wire:loading.attr="disabled">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                <x-jet-secondary-button class="bg-red-500" wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                    {{ __('Cancel') }}
                </x-jet-secondary-button>

                <x-jet-button class="ml-3 bg-red-500"
