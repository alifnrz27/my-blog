    ...
    <section class="pt-20 lg:pt-[120px] pb-10 lg:pb-20">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap items-center -mx-4 mb-12">
                                    <div class="w-full md:w-1/2 px-4">
                                        <div id="tags" data-id="{{ $post->id }}" class="flex items-center flex-wrap mb-8 md:mb-0 wow fadeInUp" data-wow-delay=".1s">
                                        
                                        </div>
                                    </div>
                                    <div class="w-full md:w-1/2 px-4">
                                        <div class="flex items-center md:justify-end wow fadeInUp" data-wow-delay=".1s">
                                            <span class="text-sm text-body-color font-medium mr-5">
                                                Share This Post
                                            </span>
                                            <div class="flex items-center">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ url('/').'/journals/'.$post->slug }}" target="_blank" class="mr-4 mb-2">
                                                ...
                                                <a href="https://twitter.com/share?url={{ url('/').'/journals/'.$post->slug }}&text=Check it out" target="_blank"class="mr-4 mb-2">
                                                ...
                                                <a href="https://www.linkedin.com/shareArticle?url={{ url('/').'/journals/'.$post->slug }}&title={{ $post->title }}" target="_blank" class="mb-2">
                    ...
                    <div class="mb-10 group wow fadeInUp" data-wow-delay=".1s">
                        <div class="rounded overflow-hidden mb-8">
                            <a href="blog-details.html" class="block">
                                <img src="/assets/images/blog/blog-01.jpg" alt="image"class="w-full transition group-hover:scale-125 group-hover:rotate-6"/>
                            </a>
                        </div>
                    <div>
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div class="mb-10 group wow fadeInUp" data-wow-delay=".15s">
                <div class="rounded overflow-hidden mb-8">
                    <a href="blog-details.html" class="block">
                        <img src="/assets/images/blog/blog-02.jpg" alt="image" class="w-full transition group-hover:scale-125 group-hover:rotate-6"/>
                    </a>
                </div>
                <div>
                    <span class="bg-primary rounded inline-block text-center py-1 px-4 text-xs leading-loose font-semibold text-white mb-5">
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div class="mb-10 group wow fadeInUp" data-wow-delay=".2s">
                <div class="rounded overflow-hidden mb-8">
                    <a href="blog-details.html" class="block">
                        <img src="/assets/images/blog/blog-03.jpg" alt="image" class="w-full transition group-hover:scale-125 group-hover:rotate-6"/>
                    </a>
                </div>
                <div>
                    <span class="bg-primary rounded inline-block text-center py-1 px-4 text-xs leading-loose font-semibold text-white mb-5">
        ...
        function tags(){
            ...
            $.ajax({
                ...
                success: function(data){
                    var dataHTML = ""
                    $.each(data, function(key,value){
                        dataHTML = dataHTML + `<a href="/journals/?tag=${value.tag.tag}" class="block py-2 px-5 bg-primary bg-opacity-5 text-primary rounded text-xs font-medium mr-2 md:mr-4 lg:mr-2 xl:mr-4 mb-2 hover:bg-opacity-100 hover:text-white">
                                                    ${value.tag.tag}
                                                </a>`
                    })
                    $('#tags').html(dataHTML);
